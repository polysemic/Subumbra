...
1. **Rounds 50+ — Remaining Alpha Hardening Arc**
   With R48-5, R48-6, and R49 now closed, continue with management API, signed template catalog, read-only policy UI, and the alpha release/recovery gate as staged by `council/approved/rTBD-structure-upgrade.md`.
