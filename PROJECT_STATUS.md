# PROJECT_STATUS
*Current state — updated 2026-05-13 (R65 launch docs — CLOSED; round-cleanup — CLOSED; r67-user-templates — CLOSED; r68-template-foundation — CLOSED; r69-template-lifecycle — CLOSED)*
...
5. **Deferred from r67-user-templates / r69-template-lifecycle (2026-05-13):** Top-level manifest `source:` routing and remote template prefetch remain deferred beyond **r69** pending a safe trust/update model. Docker Hub/Portainer native template fetch remains targeted for **r70+**. Low-priority template lifecycle items (community template sharing, hot-reload, formal JSON schema, shadow-warning UX) remain in `council/cleanup.md`.
