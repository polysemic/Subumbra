...
1. **Rounds 52+ — Remaining Alpha Hardening Arc**
   With R48-5, R48-6, R49, R50, and **r51-signed-template-catalog** now closed, continue with read-only policy UI (`r52`) and the alpha release/recovery gate (`r53`) as staged by `council/approved/rTBD-structure-upgrade.md`.
