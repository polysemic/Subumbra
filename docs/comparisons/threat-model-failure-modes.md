...
- The normal app runtime is not supposed to contain provider plaintext. A leaked app config exposes a consumer token, not a provider credential. [src:subumbra-claude]
