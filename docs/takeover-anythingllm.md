...
[`docs/standalone-anythingllm.md`](./standalone-anythingllm.md).
...
Use this env shape for the LLM takeover:

```env
LLM_PROVIDER=generic-openai
GENERIC_OPEN_AI_BASE_PATH=http://subumbra-proxy:8090/t/v1
GENERIC_OPEN_AI_API_KEY=<key_id>
...
For fresh embeddings through Subumbra, use:

```env
EMBEDDING_ENGINE=generic-openai
EMBEDDING_BASE_PATH=http://subumbra-proxy:8090/t/v1
GENERIC_OPEN_AI_EMBEDDING_API_KEY=<key_id>
